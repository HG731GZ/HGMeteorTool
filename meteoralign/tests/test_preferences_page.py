...
from meteoralign.application.preferences_page import (
    DEFAULT_ONLY_PREFERENCE_KEYS,
    EDITABLE_PREFERENCE_KEYS,
    PreferencesPage,
)
from meteoralign.application.about_dialog import AboutDialog
from meteoralign.application.preferences_dialog import PreferencesDialog, PreferencesLauncher
...
def test_disabling_exif_time_sync_does_not_read_image_capture_time(monkeypatch) -> None:  # type: ignore[no-untyped-def]
    ...
    monkeypatch.setattr(
        "meteoralign.application.app_image.read_image_capture_time",
...
def test_about_dialog_displays_qrcodes_and_project_links() -> None:
    ...
    assert "https://github.com/HG731GZ/HGMeteorTool" in dialog.ui.labelProjectGithubLink.text()
