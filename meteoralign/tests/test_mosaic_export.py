...
import meteoralign.mosaic_export as mosaic_export_module
from meteoralign.coordinates import unit_vectors_to_radec
from meteoralign.mosaic.export.remap_repair import (
...
from meteoralign.mosaic_export import (
...
def test_smart_repair_exactly_fills_only_fast_fallback_and_skips_low_weight(caplog) -> None:
    ...
    with caplog.at_level("INFO", logger="meteoralign.mosaic.export.remap_repair"):
